...
## Parses output from memcached to get tail latencies
...
## Parses rdtsc timestamps (if exists)
            ...
            for rapl in rapls:            
                for i in range(0, iters):
                    if exists(i, itr, d, rapl, qps) == True:
                        ...
                        ## sum of all core metrics summarized
