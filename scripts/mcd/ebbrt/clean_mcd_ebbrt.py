...
itrs = ["0", "2", "4", "10", "20", "30", "40", "50", "100", "150", "200", "300", "400", "666"]
rapls = ["135", "95", "75", "55"]
qpss = ["40000", "50000", "75000", "100000", "200000", "400000", "600000", "1000000", "1500000"]
sleep_states=["c1", "c1e", "c3", "c6", "c7"]

iters = 10
possible_qps_vals = np.array([40000, 50000, 75000, 100000, 200000, 400000, 600000, 1000000, 1500000])
...
print("sys i itr dvfs rapl read_5th read_10th read_50th read_90th read_95th read_99th measure_QPS target_QPS time joule rx_desc rx_bytes tx_desc tx_bytes instructions cycles ref_cycles llc_miss c1 c1e c3 c6 c7 num_interrupts")
